...
function showResult() {
    ...
    if (userScore == 10) {
        let scoreTag =
            "<span>Parabéns! Você pontuou " +
            userScore * 10 +
            " de " +
            questions.length * 10 +
            ", Você é um nerd de carteirinha!</span>";
        scoreText.innerHTML = scoreTag;
    } 
    else if (userScore >= 6 || userScore <= 9) {
        let scoreTag =
            "<span>Hmm, você pontuou " +
            userScore * 10 +
            " de " +
            questions.length * 10 +
            ", da para melhorar!</span>";
        scoreText.innerHTML = scoreTag;
    } else if (userScore >= 1 || userScore <= 5) {
        let scoreTag =
            "<span>Legal! Você pontuou " +
            userScore * 10 +
            " de " +
            questions.length * 10 +
            ", um conhecimento de amador eu diria...</span>";
        scoreText.innerHTML = scoreTag;
    } else {
        let scoreTag =
            "<span>Vish, você pontuou " +
            userScore * 10 +
            " de " +
            questions.length * 10 +
            ", Flopou hein!</span>";
